...
* [ ] Сделать функцию `lang_get_key` на арифметике, опираясь на факт последовательного расположения клавиш
* [ ] Сделать функцию `lang_get_lang` на арифметике и сравнениях
* [ ] Аналогично с функцией `shift_get_shift`
* [ ] Навести порядок в файлах, засунуть их друг в друга
* [ ] Сделать обработку по таймеру, чтобы автошифт автоматически выключался.