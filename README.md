...
* Что-то недостаточно убедительно.
...
* Практически не используешь мизинцы, и делаешь в основном всё указательными, редко средними, и редко безымянными.
...
Вот здесь видно, что начинается первая часть, где СК неадекватна для десятипала. А теперь взглянем какие можно сделать зоны для правильной клавиатуры, а например для моей:
...
Так же нужно отметить, что приобретая правильную клавиатуру, скорее всего придётся переучиваться под десятипал, потому что там динамика не прокатит из-за отсутствия стаггера, и иногда, разделённых половинок. Поэтому десятипал неразрывно связан с правильными клавиатурами.
...
А после достижения 150-200 символов в минуту советую вам уйти на клавогонки, начать читать форум, и смотреть как развивались другие люди. 300 символов в минуту дадутся легко. А уже дальше могут начаться проблемы.
