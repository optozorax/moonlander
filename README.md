...
[//]: # "start-toc"
   ...
   * [Про слепую десятипальцевую печать](#про-слепую-десятипальцевую-печать)
      * [Зоны десятипала](#зоны-десятипала)
...
Так же стаггер `\\\\` намного лучше виден на клавиатуре, у которой все клавиши имеют одинаковый размер:

![](img/wrong_planck.png)

Теперь взглянем какие можно сделать зоны для правильной клавиатуры, а например для моей:
...
Компания ZSA хороша тем, что она делает продукт не только для программистов, поэтому у них есть официальный визуальный конфигуратор раскладок для всех их клавиатур. В этом конфигураторе можно использовать множество фич QMK, можно там же печатать на тренажёре, и можно смотреть на другие раскладки. Называется этот конфигуратор [Oryx](https://www.zsa.io/oryx/). Вот как выглядит этот конфигуратор:

![](img/oryx.png)

Затем нажимаешь снизу кнопочку, и скачиваешь свою раскладку в виде уже готовой прошивки, либо в виде исходного кода. Так как я программист, то для меня самое главное - исходный код. Я скачал его, узнал что и как делается, почитал документацию по QMK, и начал писать собственные расширения.
