...
Пока что без объяснений, просто кидаюсь картинками. Все картинки кликабельны и ведут на сайт где эта раскладка находится.
...
**Смещение рядов** aka горизонтальный **стаггер** - недостаток стандартной клавиатуры. Более подробно можно посмотреть в статье ["Генетические недостатки стандартной клавиатуры"](http://ibnteo.klava.org/keyboard/standard).

**Десятипал** - сокращение для фразы: метод слепой десятипальцевой печати на клавиатуре™.

**Программируемая** клавиатура - такая клавиатура, внутрь которой можно поместить нестандартную раскладку. Более подробно об этом будет сказано далее в секции [Связь между клавиатурой и раскладкой](#связь-между-клавиатурой-и-раскладкой).

**Правильная** клавиатура - клавиатура, которая адекватна для десятипала, а именно:
...
**Раскладка** - способ организации клавиш на клавиатуре: положение букв, стрелок, F-клавиш, модификаторов итд.

[**Клавогонки**](https://klavogonki.ru) - сайт-тренажёр для печати на клавиатуре, где можно хорошо развивать скорость.

**Слой** - программшная абстракция, которая позволяет при нажатии определённой клавиши иметь клавиши, отличные от текущих. Например, зажатие клавиши Fn активирует слой, на котором в определённых местах есть клавиши управления звуком, музыкой и прочим. Более подробно об этом будет рассказано далее в секции [Введение: что такое слой](#введение-что-такое-слой).
...
Так как я не люблю паять, то купил именно её. В данной статье будет представлена раскладка именно для этой клавиатуры.
