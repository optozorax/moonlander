...
Затем я вытащил символы КМ на домашнюю позицию, а ЕИ поставил поближе на один символ. От этого тоже число перекатов значительно увеличилось.
...
Для начала почему стрелки должны быть в слое.
...
В общем разобрались почему стрелки должны быть в слою, теперь почему стрелки должны быть ширины 4 и высоты 1.
...
Обоими этими свойствами не обладает первый вариант. Но первый вариант является знакомым, но он знаком только расположением стрелок, и всё.

Знаешь, стрелки с зажатым контролом это "неизвестная необходимость" (это я придумал). 
...
* А если во нужно передвинуться всего несколько раз по словам, а потом по одному символу? Тогда надо отжимать и нажимать снова контрол. А как известно, необходимость зажимать клавишу на определённый промежуток времени сильно тратит мыслетопливо.

А когда имеется отдельные клавиши с уже зажатым контролом, то чтобы их нажать единственное что нужно сделать - это просто нажать пониже. Всё. И таким образом можно невероятно быстро передвигаться по словам и по символам. Особенно это становится актуально при длинных именах в программировании. Или при редактировании текста проще 3 раза нажать влево с контролом, чем 20 раз просто стрелкой влево, или чем зажимать стрелку влево, и высчитывать момент когда она разгонится и остановится.

Если хочется, то можно ещё сверху, на цифроряде разместить Ctrl+ Home End. Ctrl+Pg Up, Ctrl+Pg Down тоже можно, но это настолько частая комбинация, что мы о ней поговорим на зелёном слое.
...
Следующий пункт: как должно быть <kbd>◀ ▼ ▲ ▶</kbd> или <kbd>◀ ▲ ▼ ▶</kbd>?
