...
**Смещение рядов** aka **горизонтальный стаггер** - недостаток СК. Более подробно можно посмотреть в статье ["Генетические недостатки стандартной клавиатуры"](http://ibnteo.klava.org/keyboard/standard).
...
[**Клавогонки**](https://klavogonki.ru) - сайт-тренажёр для печати на клавиатуре, где можно хорошо развивать скорость. Обладает элементами социальной сети, и форумом.
...
* Зажатие <kbd>Shift</kbd> вместо цифр можно набирать знаки. 
...
Как я уже говорил, правильная клавиатура адекватна для десятипала. Я считаю что клавиатура должна соответствовать этим критериям, чтобы считаться правильной:
...
По зонами видно что подтверждается первый пункт, согласно которому СК неадекватна для десятипала. Происходит это именно из-за горизонтального стаггера, который сделан в одну сторону, и который из-за особенностей печатных машинок ещё не равномерный между рядами. Выглядит этот стаггер следующим образом, как и стандартные зоны: `\\\\`.
...
![](img/wrong_planck.png)

Теперь взглянем какие можно сделать зоны для правильной клавиатуры, а именно для моей:
...
Тут приходит ещё один пункт неадекватности СК - смещение кисти для доступа к далёким клавишам.
...
Это удивительно, но **почему** в СК большой палец не используется ни для чего, кроме пробела? Конечно, мой вопрос риторический, и адекватного ответа на него не сущесвует, только исторические причины.

Большой палец - один из самых подвижных пальцев. Да на телефонах люди печатают очень много текста одним или двумя большими пальцами. И такой мощный палец обойдён стороной.

СК не использует большой палец, хотя могла бы, и это последняя причина неадекватности СК не только длся десятипала, а и самой по себе.

Большой палец силён, поэтому правильная клавиатура имеет под каждый большой палец не как минимум три кнопки. А на эти три кнопки далее уже можно повесить много чего полезного.

## Скорость и сомнения

Хотел бы я сказать, что овладев десятипалом, можно начать печатать быстрее, но я не могу дать таких гарантий.

Например, обычно школьник 15 лет, давно печатающий вслепую, по динамическим зонам, имеет скорость в районе 300-500 символов в минуту. А это довольно немало. И если этот школьник, прямо сейчас, в своём молодом возрасте, зайдёт на клавогонки, и начнёт очень активно тренироваться, то в силу твоего возраста, он будет очень быстро расти. И после определённого времени сможет вообще достичь самого высочайшего ранга скорости - Тахион, достигнув 900 символов в минуту. Я наблюдал очень много таких примеров, и ещё больше я наблюдал примеров школьников, которые приходили со скорость 400, и очень быстро росли до менее амбициозных скоростей - 600-700 символов в минуту.
...
А что тем временем десятипал? У меня ушло больше года, чтобы достичь скорости 500 символов в минуту. И я при этом очень очень тяжело тренировался, и начал в 17 лет. Сейчас моя максимальная скорость на клавогонках - 700 символов в минуту.
...
* Затем Константин Кадавр между делом, в рандомном месте, упоминает что считает тех, кто печатает за 300 символов в минуту уже сверхлюдьми.
...
Вот так, у меня в голове засела идея что неплохо было бы научиться **Методу Слепой Десятипальцевой Печати На Клавиатуре™**, и желательно сразу поставить раскладку Дворака для английского языка.
...
Ближе к концу 11 класса школы (2016 год) я начал копать о том как стартануть. 
...
Затем, когда я сделал эту идеальную раскладку, я наконец начал обучаться десятипалу через тренажёр VerseQ. После него я перешёл на [Клавогонки](http://klavogonki.ru), и катал с такой модификацией раскладки долгое время катался под аккаунтом [optozorax](http://klavogonki.ru/u/#/451401/). Там же можно более подробно прочитать про эту раскладку.
...
А вообще для старта печати советую [klava.org](https://klava.org), он бесплатный, и там есть много функций.
...
Сначала я столкнулся с проблемой, что мои пальцы ходили не туда во время печати, и мне очень сложно было себя контролировать. Поэтому я сделал такие штуки из бумаги:

![](img/paper_zones1.jpg)

![](img/paper_zones2.jpg)

Тут главная проблема в том, что из обычной бумаги это не сделаешь, надо из твёрдой, ибо обычная помнется и не будет чувствоваться.

Далее проблема была в том, что эти бумажки падали, поэтому пришлось их клеить на стенки сверху и снизу. А еще на этих бумажках пришлось вырезать некоторые участки, чтобы пальцы могли двигаться без помех.

У меня ушло очень много времени на создание, и в итоге, когда я начал печатать - понял что это полная фигня, весь труд того не стоил, уж лучше я буду контроллировать себя не физически, а умственно. 

Затем я столкнулся с проблемой, что у меня подглядывание на клавиатуру зашито уже на подкорку, и я не мог печатать без подглядывания, поэтому скрафтил такое:
...
_Лайфхак_ 👨‍💻
> Затем в голову пришла гениальная мысль, что подсматривание на клавиатуру не будет иметь смысла, если надписи на клавиатуре не будут иметь смысла, поэтому я вытащил все клавиши и расставил их в рандомном порядке. Это наиболее дешёвый метод борьбы с подглядыванием.
...
Для сравнительного понимания что каждая скорость означает, я делал такие замеры:

|Вид деятельности|Скорость|Пруфы|
|-|-|-|
|Чтение|1800|Проверено на мне и моём друге.|
|Разговор размеренным темпом без пауз|1200|Проверено на мне и моём друге.|
|Написание текста ручкой|160|Проверено только на мне.|
|Написание текста на смартфоне с сенсорным экраном, стандартным размером, без Т9 и без свайпа|150|Проверено только на мне.|
...
Я всегда понимал, что ЙЦУКЕН - не предел мечтаний, и на нём не очень удобно печатать, и наконец, познакомившись с [Kanazei](https://klavogonki.ru/u/#/439088/)'ем, я решился немного переставить буквы, чтобы сделать свою жизнь проще. А именно, я поменял местами Щ⬌Н, Ш⬌Т. Согласно теории, такая перестановка должна была ввести в игру самое частое двубуквенное сочетание: `ТО` в виде удобного и быстрого переката. Ну и `ТГ`, `НТ` итд.
...
Еще же главная проблема старых рефлексов по нажатиям клавиш в том, что у нас руки привыкли нажимать сочетания, и эти сочетания уже ощущаются отдельно от букв. Например, ТЬ, мы это уже не воспринимаем как две буквы, а как одно действие как одну новую букву. И поэтому, даже если мы научимся нажимать Т в новом месте, это не значит, что все такие действия будут тоже правильно нажиматься. И вот с каждой клавишей таких действий связано очень много, и всех их надо переучивать.

По ощущениям печатать с ТО на перекате было шикарно, мой потенциал скорости увеличился.

Где-то в сентябре я продолжил перестановки, и теперь сделал К⬌Е и М⬌И, а затем Ф⬌К и Ы⬌М. Количество перекатов у меня стало ещё больше.
...
Далее в этой статье я буду использовать результаты этой статистики.

## Кладенец

Летом 2019 года я оказался в Москве на стажировке.

7 сентября 2019 проходил Moscow Maker Faire, где Волька вместе с Suenot'ом представляли свои клавиатуры. Так как я находился в Москве, такой шанс нельзя было упускать и я пришёл наконец встретиться вживую. Заодно потыкался в тогдашнюю Волькину новую клавиатуру [Кладенец](https://ibnteo.github.io/kladenets/README-RU):

![](img/kladenets_first_time.jpg)

До этого, в чатике, было сложно воспринимать как работает Кладенец и что это вообще такое, но после того как вживую потыкался, очень понравилось.

В итоге я пришёл к тому, что хочу попробовать научиться печатать на Кладенце. И 15 сентября Волька подарил мне самый первый экземпляр, и я начал учиться:
...
Когда я начал учиться, первые впечатления остались те же, мне показалась гениальной идея полисимвольности и возможности работать полностью одной рукой.

Потихоньку, помаленьку я стал печатать дальше. Обучение Кладенцу шло намного сложнее, чем обучение десятипалу, аккорды и двукнопия было нажимать сложно.

Я понимал, что Кладенец - это эксперимент, и я не могу отказаться от своей обычной печати.
...
Так как Кладенец - очень интересная и сложная клавиатура, он начал давать мне разные идеи по визуализации его раскладки.
...
В итоге я достиг скорости около 300 в словаре соточка на Кладенце одной рукой, и сейчас уже на нём печатаю очень редко.

Это был очень интересный опыт, после которого я открылся аккордам и использованию их в раскладке.
