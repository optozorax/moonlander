...
Так же нужно сказать что я отказываюсь от СК. Я отказываюсь от пользования ею, и я отказываюсь делать свою раскладку такой, чтобы мне потом было проще работать на СК. Я отказался от неё ещё в первый день, когда начал писать раскладку на WinAPI. 

За счёт этого я живу с максимальным удобством для себя, но и это приносит другое неудобство, что я не могу работать за чужим компом, не могу пользоваться ноутбуком, не подключая свою клавиатуру. И свою клавиатуру мне необходимо таскать везде, где я потенциально буду долго работать.

А если мне и придётся пользоваться СК где-то, то из-за максимальной непривычности, я буду сильно страдать. Так же я не могу печатать на своей клавиатуре на олимпиадах по программированию. И они даже запрещают пользоваться своей клавиатурой по правилам, особенно если там есть микроконтроллер. Ну и пусть идут нафиг.
...
В общем всё свелось к тому, что я тупо перестал запускать линукс, потому что было слишком сложно и больно этим пользоваться. И сидел на винде.

Всё изменилось, когда переустановил линукс и вернул графическую оболочку с управлением мышью. Всё-таки этот i3 не для меня. Винда меня испортила.
